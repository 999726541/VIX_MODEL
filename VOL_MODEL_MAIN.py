...
def main(expiration_t,nearest_timestamp,wholeTable=None):
    assert isinstance(expiration_t,list), 'input of exiration data must be list'
    alldata,und_price = get_spx_opt_data(expiration_t,nearest_timestamp,whole_table=wholeTable)
...
if __name__=='__main__':
    ...
    print(find_which_two_options(30,cur_date='2016-02-18 09:40:00'))
